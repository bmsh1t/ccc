...
15. For the primary /report reporting workflow, generate reports with generate_reports before finish when findings or useful artifacts exist; generate_reports is the compatibility path behind /report.
